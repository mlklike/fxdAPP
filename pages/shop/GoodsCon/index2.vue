...
<!-- 	  <view style="display: flex;justify-content: center;">
		  <image class="goods_img" lazy-load fade-show :src="storeInfo.image" mode="aspectFit"></image></view> -->
		    <product-con-swiper :img-urls="[storeInfo.image]"></product-con-swiper>
      ...
      <view class="wrapper">
        <view class="share acea-row row-between row-bottom">
          <view class="money font-color-red" >
            ...
            <text class="vip-money" v-if="storeInfo.vipPrice && storeInfo.vipPrice > 0">单购价:￥{{ attr.productSelect.vipPrice || storeInfo.vipPrice }}</text>
			<view style="margin-top: 20rpx;"><text class="money" style="color: #000000;">产品标题: {{storeInfo.storeName}}</text></view>
          </view>
        </view>
		<view>
		   <view style="border: 1px solid #dfdfdf;line-height: 50rpx;width: 130rpx;height: 50rpx;
		   text-align: center;margin-top: 30rpx;font-size: 28rpx;margin-left: 1rpx;">产品参数</view>
		   <view style="border-bottom: 1px  solid #dfdfdf;"></view>
		   <view style="display: flex;margin-top: 30rpx;">
			   <view style="width: 50%;text-align: center;">产品规格:{{storeInfo.specTypeDec}}</view>
			   <view style="width: 50%;text-align: center;">净含量:{{storeInfo.netQty}}</view>
		   </view>
		   <view style="display: flex;margin-top: 30rpx;">
		   			   <view style="width: 50%;text-align: center;">品牌名称:{{storeInfo.specTypeDec}}</view>
		   			   <view style="width: 50%;text-align: center;">产地:{{storeInfo.netQty}}</view>
		   </view>
		</view>
      </view>
      <!-- 商品详情 -->
      <view class="product-intro">
       <view style="border: 1px solid #dfdfdf;line-height: 50rpx;width: 130rpx;height: 50rpx;
       text-align: center;margin-top: 30rpx;font-size: 28rpx;margin-left: 1rpx;">产品详情</view>
       <view style="border-bottom: 1px  solid #dfdfdf;"></view>
    ...
    <!--    <!-- #ifdef MP-WEIXIN -->
      ...
      <!--  <view class="item" @click="goHome">
        ...
        <view class="item" @click="$yrouter.push({ path: '/pages/order/GoodExchange/index', query: { couponCode: couponCode }})">
...
export default {
  ...
  mounted() {
    ...
    const token = cookie.get('logStatus')
    if (url && url.id) {
      this.id = url.id
