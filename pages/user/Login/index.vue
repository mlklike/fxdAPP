<template>
  <view class="register absolute container">
<!-- 	<img :src="logoUrl" style="height: 700rpx;width: 80%;border: 1px solid;"/> -->
    <view class="whiteBg" style="margin-top: 360rpx;" v-if="formItem === 1">
	...
	<!-- 注册 -->
    <view class="whiteBg" style="margin-top: 360rpx;" v-else>
  ...
  export default {
    ...
    methods: {
		...
		async submit() {
			...
			if (res.status === 200) {
				console.log(dayjs(res.data.expires_time))
